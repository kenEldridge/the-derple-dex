...
- **[Research Note: Melody as a Log-Derivative](https://github.com/kenEldridge/the-derple-dex/issues/4)** -- Adversarial audit of the claims in this post, with primary sources and falsification criteria.
