...
*Total dissonance summed across all harmonic partial interactions (30 partials). Deep minima at simple frequency ratios (2:1, 3:2, 4:3, 5:4) correspond to consonant musical intervals. Use the in-plot toggle ("12-TET: Off / Lines / Lines+Labels") to overlay equal-tempered note positions.*
