...
This is not just abstract math. In equal temperament, each piano key multiplies frequency by the same factor ($2^{1/12} \approx 1.059$). Equal key spacing corresponds to equal log-frequency steps.
