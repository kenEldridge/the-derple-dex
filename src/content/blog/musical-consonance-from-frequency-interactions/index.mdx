...
*Total dissonance summed across all harmonic partial interactions (30 partials). Deep minima at simple frequency ratios (2:1, 3:2, 4:3, 5:4) correspond to consonant musical intervals. Use the controls above the plot to show/hide minima guides and switch overlays between 12-TET interval labels or key/scale note labels.*
